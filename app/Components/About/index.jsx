            ...
            <div className="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  <p className="text-[1rem] text-left text-body-color mb-9 leading-relaxed">
                  Transparency is a fundamental value for us. Through the use of fantom technology, we aim to provide a high level of transparency and traceability in the fundraising process. We want donors to easily verify how funds are being utilized and if campaign objectives are being met.
                  </p>
                  <p className="text-[1rem] text-left text-body-color mb-9 leading-relaxed">
